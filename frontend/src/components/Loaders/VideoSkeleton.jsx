        ...
        <div className='relative '>
            <div className='w-full absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-gradient-to-r from-transparent via-white/40 to-transparent z-1'></div>
                ...
                <div className='w-full flex  flex-col items-center '>
                    <div className={`w-full flex justify-center ${darkTheme? "bg-black":"bg-white"} `}>
                    <div className={`${darkTheme? "bg-white/20": "bg-black/20"}   max-w-max w-full h-screen max-h-screen aspect-9/16 relative`}>
