...
function Profile(props) {
    ...
    return (
        <div className={` flex flex-col   h-screen text-blue-600`}>
            {
                setting &&
                <div className={`fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 ${darkTheme? " bg-black/10 border-black/10": "bg-white/10 border-white/20"} backdrop-blur-2xl shadow-xl border  flex flex-col justify-center items-center w-max  px-2 rounded-xl`}>
