...
function Profile(props) {
    ...
    return (
        <div className={` flex flex-col   h-screen text-blue-600`}>
            {
                setting &&
                <div className={`fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 ${darkTheme? " bg-black/10 ": "bg-white/10 "} backdrop-blur-2xl shadow-xl border border-white/20 flex flex-col justify-center items-center w-max  px-2 rounded-xl`}>

                <div className='flex items-center border-b border-white px-8 py-2'>
